...
export class GeneralErrorDto {
  ...
  @ApiProperty({
    ...
    required: true,
    description: 'Hata mesajı',
    default: 'Hata Oluştu, Lütfen daha sonra tekrar deneyiniz.',
  })
  message = 'Hata Oluştu, Lütfen daha sonra tekrar deneyiniz.';
}

export class SortableDto {
  @ApiProperty({ type: Number, required: true, description: 'Islem ID' })
  @IsNotEmpty({ message: 'Id geçersiz' })
  id: number;
}
